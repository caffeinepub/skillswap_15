...
export class Backend implements backendInterface {
    ...
    async acceptExchangeRequest(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.acceptExchangeRequest(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createOrUpdateProfile(arg0: string, arg1: string, arg2: Array<Skill>, arg3: Array<Skill>): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAverageRating(arg0: Principal): Promise<number | null> {
        if (this.processError) {
            try {
    ...
    async getMyExchangeRequests(): Promise<Array<ExchangeRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMyExchangeRequests();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async sendExchangeRequest(arg0: Principal, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.sendExchangeRequest(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
